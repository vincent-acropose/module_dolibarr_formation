...
<div class="tabsAction">
	[onshow;block=begin;when [user.rights.formation.write;noerr]=1]
	
		[onshow;block=begin;when [object.status]=[Tformation.STATUS_DRAFT]]
		...
		[onshow;block=begin;when [object.status]=[Tformation.STATUS_VALIDATED]]
		...
		<!-- '-+' est l'équivalent d'un signe '<' (TBS oblige) -->
		[onshow;block=begin;when [object.status]-+[Tformation.STATUS_REFUSED]]
