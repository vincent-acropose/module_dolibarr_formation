 ...
 */
class formationbox extends ModeleBoxes
{

    public $boxcode = "mybox";
    public $boximg = "formation@formation";
    public $boxlabel;
    public $depends = array("formation");
    public $db;
    public $param;
    ...
    public function loadBox($max = 5)
    {
        ...
        //include_once DOL_DOCUMENT_ROOT . "/formation/class/formation.class.php";
